...
% - esprit scientifique s'intéressant de près au fonctionnement des sociétés (parler brièvement de mes envie de voir le monde) par l’étude de son économie et aux innovations technologie, image de sa créativité. J'ai choisi d'évoluer dans le domaine informatique pour tous ces aspects là de mes intérêt / penchant


% - j'aimerai continuer de m'investir dans un modèle économique laissant la place à une créativité sans borne et dans lequel les moyens financiers nécessaires à de telles ambitions restent considérables et synonymes d'évolution constante. Un modèle qui est risqué mais grisant. Passionnant
