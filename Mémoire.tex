...
\paragraph{}
Lors de mon arrivé dans les rang de HappyBox il m'a éte confié une mission claire: batir une infrastructure pouvant acceuillir une forte masse d'utilisateur environ 10 000. Pour résoudre ce probléme j'ai adopté une approche basé sur les méthodes scientifique que j'ai pu observé durant mon stage chez Biogemma. La méthode est simple et repose sur l'observation et l'analyse.
Selon il faut effectuer des cycles basé sur la durée de croissance d'une pousse de blé in vitro et son séquençage en laboratoire. Cela permettant de s'adapter et de modifier ses objectifs à partir des résultats obtenue lors de l'itération précédente. Il est nécessaire dans le cas de recherche de pratiquer ce genre de méthode car explorer une piste voué l'echec coute chére financièrement et humainement parlant. C'est un cycle composé de six étapes: Observation, réfléxion, documentation, projection, action et analyse.
N'ayant pas des contrainte logistique importante dans le cadre d'une expérience j'ai choisi d'adopter un cycle hebdomadaire. Chose possible grâce la quasi-total autonomie dont dans laquelle j'évolué. Chaque semaine, un j'ai établie un bilan de l'impact des choix de la semaine précédente. Chose facilité par la tenue d'un cahier de recherche\footnote{Les chercheurs ne pouvant produire un résultat aisément mesurable, il leur est demandé de documenter le travail. C'est un outils extremement utile à la fois pour les chercheurs présent et future. En effet, ces cahiers son archivé et indexé afin de ne rien perdre du travail et des réflexion effectuer. } contenant un résumé de mon travail, de mes notes prises au contact de Guillaume et Danny et de mes réflexion tenu à jour en temps réel. Ce cahier dois être daté afin de pouvoir s'en servir comme support de travail à long termes. c'est l'élément fondamentale de la phase d'observation car il deviens une mémoire alternative diffusable. 
Il ne s'agit pas réellement d'une cyclique car pour optimiser la recherche il est possible de le paralléliser afin de compenser l'aspect bloquant de certain axe. Durant l'attente des résultats d'une expérience on il est possible de préparer la seconde et ainsi de suite. Les travaux de réflexion et de documentation servent préparer la mise en place de l'experience car l'on cherche à éviter de travailler avec des paramétres inconnus pouvant fausser les résultat chose qui n'est souvent visible qu'après plusieurs itération et représentant un perte de temps colossale.

\paragraph{}
Il est possible de possible d'adapter cette approches dans tout type de projet demandant une grande autonomie ou un réfléxion complex et structuré. Dans le cadre d'une startup, elle particulièrement redoutable car elle m'a permis de m'adapter trés rapidement aux besoins changeant. 

J'ai aussi petit à petit dériver d'un rôle purement technique à une place demandant une vision plus globale du projet. Il n'est pas envisageable, dans un cadre de travail aussi changeant, de conserver une approche linéaire et prévue à long terme. 

En effet les besoins étant peux conventionel il m'a fallut apprendre beaucoup de choses rapidement. L'étape de documentation a été fondamentale en ce sens car on peu à la fois allier formation et expérimentation hors du context de production permettant de  réduire au maximum les difficultés technique et la plupart des problèmes triviaux. 

\paragraph{}
Cette pratique n'est pas récente. Il s'agit de la base de la méthode scientifique. Cette dernières est adaptable en toute situation et permet d'augementer les performances en terme de recherche et developpement. De plus elle permet d'explorer des problémes complexe par étapes simplifiant ainsi la résolution des erreur. Ou la navigation dans un arbre de possibilité.
