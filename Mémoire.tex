...
\paragraph{}
Ayant essayé durant mes quatres années d'étude différent types de structure: petit commerce, groupe para-pharmaceutique, compagnie de recherche privé au seins d'un groupe internationale, fonction publique et finalement startup. 
Lors de mon année de M1 a montreal j'ai pu découvrir le monde des startups. Plus précisement les startups vivant pour et par le web. 
\subparagraph{}
Un milieu déjanté ou les entrepreneur s'entasse à trente dans des lofts ou il loue un bureau. Ce ne sont pas des incubateurs mais souvent des particulier ayant de grand espaces à louer. Les startups vive et meurent aussi vite ici que dans la silycon valley. 
\subparagraph{}
Au fond de moi même j'ai tout de suite été attiré par ce monde. Il me fascine encore à l'heure actuelle et ne semble régit par aucune autre lois que celle de la \emph{croissance}. Depuis trés jeune me suis intéressé à l'économie en tant que concepts théorique, les stratups étant des laboratoire d'expérimentation économique cela à permis d'ajouter une dimension pratique à mes connaissances. De plus l'aspect hautement technologique de ces entreprises m'a hapé. 
\subparagraph{}
Cette envie professionnelle c'est s'est insidieusement installé tout aux long de dces cinq dernières années. La stratup semble être la structure présentant le plus d áffinité avec mon projet professionnels car il fournis l'envirronement technologique que j'aime tant.

\paragraph{}
Dans un milieu aussi fluctuent il m'a parut interessant d'en étudier les infrastructures. Je voulais savoir en quoi une politique de gouvernance pouvait modifier à la fois les performances logiciel mais aussi commercial de telles structure. Le domaine étant vaste je vous présenterai donc ma reflexion sous via trois grands axe: 

\begin{itemize}
	\item croissance accélére et économie difficile
	\item Financement et cout
	\item Gestion des utilisateurs et gestion d'infrastructures virtuelles
\end{itemize}


% Sans exposé les soucis d'HB, dire que cette boîte est trop cool et que je continues de travailler avec eux. Que mes analyses et mes réponses a problématique corresponde a mon etat d'sprit actuel mais qu'il est possible d'avoir d'autres point de vue sur la question et que je sio persuadé de pouvoir encore apporté d'autre piste d'analyse dans les années a venir en fonction du developpement de l'economie des startups en general et de HB en particulier.

Nous voilà donc partie pour une exploration de l'entrepreunariat à Montreal

% Bonne lecture de mon memoire !

% - Cette envie professionnelle s'est insidieusement installée tout au long de mes différents stages et projets personnels que j'ai effectué ces 5 dernières années. Biogemma, Montlucon, Museion, Musical Solution ?,  Parler des voyages divers, amour du Canada, envie de partir pour Montreal découvrir startup et économie capitaliste americaine HappyBox

% - HappyBox est l’expérience qui se rapproche le plus de mes ambitions professionnelles. J'ai choisi de travailler pour eux car ils étaient des passionnés qui ont un projet technologiquement innovant. Envie de découverte de ce modèle économique mythe qu'est une startup. Curiosité et aventureux : startup parfait pour moi, Happybox c'est quoi ? start-up c'est quoi ?

% - du coup j'ai choisi parler de « problematique » parce que cést important quand même de bien gouverner son projet si on veut que ca marche et pour que ca marche cela demande beaucoup de parametre de reflexion, expliquer tres briévement ma maniere scientifique de répondre a ce genre de probleme et limiter à 3 grands axes de réfléxions afin d'y répondre parce que plus c'est chiant :
% 	-croissance rapide, economie difficile (concurrence, concours de bite, recherche plus 	performance que projet louable, mort de startup meritante car gens bête qui aime juste 	farmville)

% 	-financement et coût (freemium, venture capitalism, etc, stats pour mener à determination 	utilisateur et infra)

% 	- les utilisateurs et importance de l'infra en générale en prenant pour ex celle que j'ai deployer pour HB
