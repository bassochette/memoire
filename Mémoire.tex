...
\begin{figure}{h!}
	\includegraphics[width=(\textwidth-1)]{images/media/premiumSpotify.png}
	\caption{Offre gratuite et offre premium de la plateforme d'ecoute de musique en ligne Spotify}
\end{figure}
...
hébergment à la maison peu dispendieux. 

Internet de merde
électricité de merde
connard de gosse qui débranche au milieu d'une maj ou qui télecharge du pron en 4k

sécurité physique aui pu du cul généralement.
surcout d'electricité
haute dispo impossible 
...
projection des couts à 10 ans puissance pour de calcule
			...
			\subsection{Engin PaaS, ça puT(e)}
...
Impossible de garantir que sur 1000 servuers configuré par un seul individue et qu'il n'y aura pas d'erreur. ZOB!
...
Mais y a moyen de moyenner et on vois ça aprés. cf provisionning
		...
		Petite intro bien sympa présentant la méthodes suivis:
			...
			\subsection{Estimation et calcule prévisionnel des coûts}
...
Mise en place de jira et devellopement de process. Infra ne nécessitant aucune présence physique donc startup ++ ou on vas fumer des joint avec les pote pis on code jusqu'a ce que segmentation fault s'en suive.
...
Peu dispendieuse bien que vrais lors de la mise en place. Depuis l'offre à changer, les serveurs que nous utilisions sont plus puissants 
